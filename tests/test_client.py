...
from storage3 import create_client, AsyncStorageClient, SyncStorageClient
...
def test_create_async_client(valid_url, valid_headers):
    ...
    assert all(client._client.headers[key] == value for key, value in valid_headers.items())
